<template>
  <div class="demo-lazyload">
    <div>
      <img v-for="(img, idx) in imageList" v-lazy="img"  :key="idx"/>
    </div>

    <div>
      <div v-for="(img, idx) in backgroundImageList" v-lazy:background-image="img" :key="idx"/>
    </div>

    <div>
      <lazy-component>
        <img v-for="(img, idx) in componentImageList" v-lazy="img" :key="idx"/>
      </lazy-component>
    </div>
  </div>
</template>
