<template>
  <div class="vu-swipe">
    ...
    <div v-else class="vu-swipe__track">
      <slot></slot>
    </div>
    <div class="vu-swipe__indicators" v-if="showIndicators && count > 1">
      <i v-for="index in count" :key="index" :class="{ 'vu-swipe__indicator--active': index - 1 === activeIndicator }" />
    </div>
</div>
</template>
